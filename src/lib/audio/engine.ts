...
/**
 * Raw Web Audio engine (reused from ZINEOS) — no Tone.js. A single lazily-created
 * AudioContext (browsers require a user gesture to start one, which our
 * click-driven sounds naturally provide). Each call builds a short oscillator +
 * gain envelope and tears it down on stop. Fails silent on unsupported envs.
 */
